...
export function OptionsPage({ onNavigate }: { onNavigate: (path: AppPath) => void }) {
  ...
  const { user, isAnonymous, updatePlayerProfile } = useSupabaseAuth();
